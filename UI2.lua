...
local ThemeManager = {} do
	...
	function ThemeManager:CreateThemeManager(groupbox)
		...
		groupbox:AddLabel('大部分UI颜色')	:AddColorPicker('MainColor', { Default = self.Library.MainColor });
		groupbox:AddLabel('某些位置的颜色'):AddColorPicker('AccentColor', { Default = self.Library.AccentColor });
		groupbox:AddLabel('边边角的颜色'):AddColorPicker('OutlineColor', { Default = self.Library.OutlineColor });
		groupbox:AddLabel('字体的颜色')	:AddColorPicker('FontColor', { Default = self.Library.FontColor });
		groupbox:AddInput('VideoLink', { Text = '视频中的颜色 (链接必须是Link)', Default = self.Library.VideoLink });
		...
		groupbox:AddDropdown('ThemeManager_ThemeList', { Text = '官方推荐', Values = ThemesArray, Default = 1 })
		groupbox:AddButton('设置为默认值', function()
		...
		groupbox:AddInput('ThemeManager_CustomThemeName', { Text = '自定义配置' })
		groupbox:AddButton('保存主题', function() 
		...
		groupbox:AddDropdown('ThemeManager_CustomThemeList', { Text = '主题配置', Values = self:ReloadCustomThemes(), AllowNull = true, Default = 1 })
		groupbox:AddButton('加载', function() 
		...
		groupbox:AddButton('刷新主题', function()
			getgenv().Linoria.Options.ThemeManager_CustomThemeList:SetValues(self:ReloadCustomThemes())
			getgenv().Linoria.Options.ThemeManager_CustomThemeList:SetValue(nil)
		end)
		groupbox:AddButton('设置为自动启动', function()
		...
		groupbox:AddButton('重置自动启动', function()
